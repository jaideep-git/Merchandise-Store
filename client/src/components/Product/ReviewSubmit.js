  ...
  return (
    <div className="customer_reviews">
      ...
      <div className="review_section">
        <div className="review_section1">
          ...
          <div className="product_rating3">
            <StarRatings {...ratingOptions1} rating={product.rating} />{" "}
          ...
          <div className="review_rating">
            ...
            <div className="rating_bar">
              <div
                className={"bar2"}
                style={{
                  width: `${ratingPercantageFive ? ratingPercantageFive : 0}%`,
                }}
              />
            </div>
          ...
          <div className="review_rating">
            ...
            <div className="rating_bar">
              <div
                className={"bar2"}
                style={{
                  width: `${ratingPercantageFour ? ratingPercantageFour : 0}%`,
                }}
              />
            </div>
            <div className="rating_percantage">
          ...
          <div className="review_rating">
            ...
            <div className="rating_bar">
              <div
                ...
                style={{
                  width: `${
                    ratingPercantageThree ? ratingPercantageThree : 0
                  }%`,
                }}
              />
            </div>
          ...
          <div className="review_rating">
            ...
            <div className="rating_bar">
              <div
                className={"bar2"}
                style={{
                  width: `${ratingPercantageTwo ? ratingPercantageTwo : 0}%`,
                }}
              />
            </div>
            <div className="rating_percantage">
          ...
          <div className="review_rating">
            ...
            <div className="rating_bar">
              <div
                className={"bar2"}
                style={{
                  width: `${ratingPercantageOne ? ratingPercantageOne : 0}%`,
                }}
              />
            </div>
            <div className="rating_percantage">
      ...
      <div className="review_form">
        ...
        <button className="submitButton" onClick={reviewSubmitHandler}>
          Submit
        </button>
      </div>
    </div>
